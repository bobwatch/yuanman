...
internal object DateUtils {
    ...
    /** 月份前缀 [prefix] 平移 [delta] 个月（预算历史/趋势图生成月份序列用）。 */
    fun addMonthsPrefix(prefix: String, delta: Int): String {
        val cal = java.util.Calendar.getInstance().apply {
            set(java.util.Calendar.YEAR, prefix.substring(0, 4).toInt())
            set(java.util.Calendar.MONTH, prefix.substring(5, 7).toInt() - 1)
