...
object UpdateChecker {
     ...
     * 用 ACTION_VIEW + package MIME 而非 ACTION_INSTALL_PACKAGE：官方推荐路径，
     * 部分国产 ROM 对 INSTALL_PACKAGE 支持不佳；另加 NEW_TASK（调用方可能是
     * Application context，非 Activity 启动必须带该 flag）。
     */
